...
`HTML <_static/notebooks/tutorial_1_basic.html>`_
`Google Colab <https://colab.research.google.com/github/chiba-ai-med/PyTorchDecomp/blob/main/docs/_static/notebooks/tutorial_1_basic.ipynb>`_
...
`HTML <_static/notebooks/tutorial_2_unsupervised.html>`_
`Google Colab <https://colab.research.google.com/github/chiba-ai-med/PyTorchDecomp/blob/main/docs/_static/notebooks/tutorial_2_unsupervised.ipynb>`_
...
`HTML <_static/notebooks/tutorial_3_supervised.html>`_
